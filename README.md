## NOTE: this project is work in progress and is not yet fully usable
...
- PBNET is slow. On the PB-2000 side, everything is written in DL-Pascal. While this is the best performance you can get on this platform with a high-level language, it is still slow. The maximum serial port raw performance observed was about 300 Bps in and 500 Bps out, and PBNET achieves about 200 Bps in + ~350 Bps out, because of the framing overhead (cycles spent on processing plus the actual data overhead of the encoding used). It could get quicker if framing was rewritten in assembly, but not much above 300 Bps in, 500 Bps out - still worth exploring though.
...
Like pretty much every project relating to PB-1000 and PB-2000, I would like to thank Piotr Piatek (website) for his insights into the hardware and help with testing. This man has created an amazing body of work around these platforms and he also developed FPGA/CPLD based hardware modules for serial communication and mass storage, replacing the bulky FA-7 or MD-100 - he also developed an emulator for the PB-2000 that I use for compiling PBNET without having to transfer the source back and forth. I would also like to thank Pascal a.k.a. Xerxes for pushing his pre-production DL-Pascal card to eBay one day, and Juergen Keller for his help with accessing DL-Pascal 1.2
